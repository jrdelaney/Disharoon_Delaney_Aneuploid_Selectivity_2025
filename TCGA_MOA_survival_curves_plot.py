...
def analyze_survival_curves(
    ...
    df_tmp2 = df_tmp1[df_tmp1[therapy_col] == drug_name_filter.upper()].copy() #upper because they are upper in the dataframe
    ...
    df_tmp3 = df_tmp3.drop_duplicates()
    if df_tmp3.empty:
...
analyses = [
    {
        "cancer_type_filter": "Esophagogastric Cancer",
        "drug_name_filter": "thymidylate synthase inhibitor",
        "chromosome_arm": "12p",
        "drug_name_clean": "Thymidylate Synthase Inhibitor",
        "cancer_name_clean": "Esophagogastric"
    },
    {
        "cancer_type_filter": "Non-Small Cell Lung Cancer",
        "drug_name_filter": "hypoxia inducible factor inhibitor",
        "chromosome_arm": "4q",
        "drug_name_clean": "Hypoxia Inducible Factor Inhibitor",
        "cancer_name_clean": "Non-Small Cell Lung"
    },
    {
        "cancer_type_filter": "Esophagogastric Cancer",
        "drug_name_filter": "apoptosis inhibitor",
        "chromosome_arm": "22q",
        "drug_name_clean": "Apoptosis Inhibitor",
        "cancer_name_clean": "Esophagogastric"
    }
]

save_dir = ('FIGURES_MOA_all_TCGA_treatments_survival_curves')
os.makedirs(save_dir, exist_ok=True)

# Load TCGA data
df = pd.read_csv("Final_Publication_Files/Supplemental Data 1 Full TCGA Dataset Expanded on MOA.csv", low_memory=False)

therapy_col = 'moas' # could use therapy if looking at specific drugs
